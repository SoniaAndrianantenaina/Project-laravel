                ...
                <div class="formulaire-collab__content">
                    ...
                    <div class="formulaire label">
                        <label for="">
                            ...
                            <input type="text" class="btn-blue" name="idDepartement" id=""
                    ...
                    <div class="formulaire label">
                        <label for="">
                            ...
                            <input type="text" class="btn-blue" name="idPoste" id=""
                    ...
                    <div class="formulaire label">
                        <label for="">
                            ...
                            <input type="text" class="btn-blue" name="salaire" id=""
                    ...
                    <div class="formulaire label">
                        <label for="">
                            ...
                            <input type="date" class="btn-blue" name="date_debut" id="">
                        </label>
                    </div>
